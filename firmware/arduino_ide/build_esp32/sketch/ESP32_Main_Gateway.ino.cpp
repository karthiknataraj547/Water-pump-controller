#line 1 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
/*
 * ==============================================================================
...
// ==============================================================================
#line 237 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void updateBleStatus(const String &state, const String &ip, const String &error);
#line 253 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void startBleProvisioning();
#line 319 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void stopBleProvisioning();
#line 451 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void mqttCallback(char* topic, byte* payload, unsigned int length);
#line 555 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void onEspNowDataRecv(const esp_now_recv_info_t *info, const uint8_t *incomingData, int len);
#line 586 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void TaskNetwork(void *pvParameters);
#line 776 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void TaskControl(void *pvParameters);
#line 873 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void setup();
#line 1004 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
void loop();
#line 170 "D:\\water pump\\firmware\\arduino_ide\\ESP32_Main_Gateway\\ESP32_Main_Gateway.ino"
uint16_t calculateCRC16(const uint8_t *data, size_t len) {
  uint16_t crc = 0xFFFF;
...
void mqttCallback(char* topic, byte* payload, unsigned int length) {
  ...
  if (deserializeJson(doc, message) == DeserializationError::Ok) {
    ...
    if (strcasecmp(action, "START_PUMP") == 0 || strcasecmp(action, "PUMP_ON") == 0 || strcasecmp(action, "START") == 0 || strcasecmp(action, "ON") == 0) {
      ...
      notifyMqttStatusUpdate = true;
    } else if (strcasecmp(action, "PING") == 0 || strcasecmp(action, "GET_STATUS") == 0 || strcasecmp(action, "STATUS") == 0) {
    ...
    if (!mqttClient.connected()) {
      if (millis() - lastMqttRetry > 3500) {
        ...
        if (mqttClient.connect(clientId.c_str(), "pump/status", 1, true, lwtPayload.c_str())) {
          ...
          // Subscriptions - single clean subscriptions without wildcards
